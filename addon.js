...
var ads = '<div style="padding: 0.3em 0.3em; padding-top: 0;"><div style="background: #3e3e3e; padding: 0.5em; border-radius: 1em;"><div style="line-height: 1.2;"><span style="color: #ffffff"><div style="text-align: center;"><br></br><span style="color: #f3d900"></span></span></div></div></div></div>'	

<div id="adContainer" style="padding: 0.3em 0.3em; padding-top: 0;">
    <div style="background: #3e3e3e; padding: 0.5em; border-radius: 1em;">
        <div style="line-height: 1.2;">
            <span style="color: #ffffff">
                <div style="text-align: center;">
                    <br></br>
                    <span style="color: #f3d900"></span>
                </div>
            </span>
        </div>
    </div>
...
<script>
    // Получаем элемент по ID и удаляем его
    var adElement = document.getElementById('adContainer');
    if (adElement) {
