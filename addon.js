...
/* Интерфейс */
		...
		Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
							itemON('https://v42z.github.io/plugins/tmdb.js', 'TMDB Proxy', '@lampa', 'TMDB');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://v42z.github.io/plugins/tmdb.js";
							deletePlugin(pluginToRemoveUrl);
						}
					},
					onRender: function (item) {
						$('.settings-param__name', item).css('color','f3d900'); hideInstall();
						/*var myResult = checkPlugin('https://v42z.github.io/plugins/tmdb.js')
						setTimeout(function() {	
                                                ...
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       ...
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://v42z.github.io/plugins/tmdb.js') {
			...
			Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
							itemON('https://v42z.github.io/plugins/tmdbalt.js', 'TMDB Alt', '@lampa', 'TMDB Alt');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://v42z.github.io/plugins/tmdbalt.js";
							deletePlugin(pluginToRemoveUrl);
						}
					},
					onRender: function (item) {
						$('.settings-param__name', item).css('color','f3d900'); hideInstall();
						/*var myResult = checkPlugin('https://v42z.github.io/plugins/tmdbalt.js')
						setTimeout(function() {	
						...
						var myResult = checkPlugin('https://v42z.github.io/plugins/tmdbalt.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       ...
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://v42z.github.io/plugins/tmdbalt.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
				...
				Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
							itemON('https://v42z.github.io/plugins/interface_mod.js', 'Interface Mod', '@lampa', 'Interface Mod');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://v42z.github.io/plugins/interface_mod.js";
							deletePlugin(pluginToRemoveUrl);
						}
					},
					onRender: function (item) {
				...
				Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
							itemON('https://v42z.github.io/plugins/personalhub.js', 'PersonalHub', '@lampa', 'PersonalHub');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://v42z.github.io/plugins/personalhub.js";
							deletePlugin(pluginToRemoveUrl);
						}
					},
					onRender: function (item) {
						...
						var myResult = checkPlugin('https://v42z.github.io/plugins/personalhub.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       ...
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://v42z.github.io/plugins/personalhub.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
		...
		Lampa.SettingsApi.addParam({
	        ...
	        Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
						       itemON('https://v42z.github.io/plugins/collections.js', 'Коллекции', '@lampa', 'Collections');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://v42z.github.io/plugins/collections.js";
							deletePlugin(pluginToRemoveUrl);
						}
					},
			                onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall()
						/*var myResult = checkPlugin('https://v42z.github.io/plugins/collections.js')
						setTimeout(function() {	
						...
						var myResult = checkPlugin('https://v42z.github.io/plugins/collections.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       ...
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://v42z.github.io/plugins/collections.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
	        ...
	        Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
						       itemON('https://v42z.github.io/plugins/weather.js', 'Погода', '@scabrum', 'Weather');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://v42z.github.io/plugins/weather.js";
							deletePlugin(pluginToRemoveUrl);
						}
					},
			                onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall()
						...
						var myResult = checkPlugin('https://v42z.github.io/plugins/weather.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       ...
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://v42z.github.io/plugins/weather.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
	        ...
	        Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						...
						if (value == '2') {
			                ...
			                onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall()
						/*var myResult = checkPlugin('https://v42z.github.io/plugins/cuboff.js')
						setTimeout(function() {	
						...
						var myResult = checkPlugin('https://v42z.github.io/plugins/cuboff.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       ...
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://v42z.github.io/plugins/cuboff.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
	        ...
	        Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
						       itemON('https://v42z.github.io/plugins/interface.js', 'Стильный Интерфейс', '@lampa', 'Style_interface_fix');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://v42z.github.io/plugins/interface.js";
							deletePlugin(pluginToRemoveUrl);
						}
					},
			                onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall()
						/*var myResult = checkPlugin('https://v42z.github.io/plugins/interface.js')
						setTimeout(function() {	
						...
						var myResult = checkPlugin('https://v42z.github.io/plugins/interface.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       ...
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://v42z.github.io/plugins/interface.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
				...
				name: 'Дополнительный источник Кинопоиск (KP)',
					...
					onChange: function(value) {
						...
						if (value == '2') {
			                ...
			                onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall()
						/*var myResult = checkPlugin('https://v42z.github.io/plugins/source.js')
						setTimeout(function() {	
						...
						var myResult = checkPlugin('https://v42z.github.io/plugins/source.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       ...
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://v42z.github.io/plugins/source.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
	        ...
	        Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						...
						if (value == '2') {
			                ...
			                onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall()
						/*var myResult = checkPlugin('https://v42z.github.io/plugins/start.js')
						setTimeout(function() {	
						...
						var myResult = checkPlugin('https://v42z.github.io/plugins/start.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       ...
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://v42z.github.io/plugins/start.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
	        ...
	        Lampa.SettingsApi.addParam({
						...
						onChange: function(value) {
							if (value == '1') {
								itemON('https://v42z.github.io/plugins/nots.js', 'Remove TS', '@AndreyURL54', 'ts_del');
							}
							if (value == '2') {
								var pluginToRemoveUrl = "https://v42z.github.io/plugins/nots.js";
								deletePlugin(pluginToRemoveUrl);
							}
						},
						onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall()
							/*var myResult = checkPlugin('https://v42z.github.io/plugins/nots.js')
							setTimeout(function() {	
						...
						var myResult = checkPlugin('https://v42z.github.io/plugins/nots.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       ...
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://v42z.github.io/plugins/nots.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
	        ...
	        Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						...
						if (value == '2') {
			                ...
			                onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall()
						/*var myResult = checkPlugin('https://v42z.github.io/plugins/rusmovies.js')
						setTimeout(function() {	
						...
						var myResult = checkPlugin('https://v42z.github.io/plugins/rusmovies.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       ...
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://v42z.github.io/plugins/rusmovies.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
	        ...
	        Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
						       itemON('https://v42z.github.io/plugins/quality.js', 'В Качестве', '@lampa', 'qual');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://v42z.github.io/plugins/quality.js";
							deletePlugin(pluginToRemoveUrl);
						}
					},
			                onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall()
						/*var myResult = checkPlugin('https://v42z.github.io/plugins/quality.js')
						setTimeout(function() {	
						...
						var myResult = checkPlugin('https://v42z.github.io/plugins/quality.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       ...
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://v42z.github.io/plugins/quality.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
						...
						var myResult = checkPlugin('https://v42z.github.io/plugins/logo.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       ...
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://v42z.github.io/plugins/logo.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
	        ...
	        Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						...
						if (value == '2') {
			                ...
			                onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall()
						/*var myResult = checkPlugin('https://v42z.github.io/plugins/foreign.js')
						setTimeout(function() {	
						...
						var myResult = checkPlugin('https://v42z.github.io/plugins/foreign.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       ...
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://v42z.github.io/plugins/foreign.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
					...
					onChange: function(value) {
						if (value == '1') {
						       itemON('https://v42z.github.io/plugins/lampa_rate.js', 'Рейтинг Lampa', '@lampa', 'rate_lampa');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://v42z.github.io/plugins/lampa_rate.js";
							deletePlugin(pluginToRemoveUrl);
						}
					},
			                onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall()
						/*var myResult = checkPlugin('https://v42z.github.io/plugins/lampa_rate.js')
						setTimeout(function() {	
						...
						var myResult = checkPlugin('https://v42z.github.io/plugins/lampa_rate.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       ...
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://v42z.github.io/plugins/lampa_rate.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
	        ...
	        Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						...
						if (value == '2') {
			                ...
			                onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall()
						/*var myResult = checkPlugin('https://v42z.github.io/plugins/seaseps.js')
						setTimeout(function() {	
						...
						var myResult = checkPlugin('https://v42z.github.io/plugins/seaseps.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       ...
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://v42z.github.io/plugins/seaseps.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
...
/* Управление */
		...
		Lampa.SettingsApi.addParam({
	        ...
	        Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
						       itemON('https://v42z.github.io/plugins/redirect.js', 'Смена Сервера', '@scabrum', 'Redirect');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://v42z.github.io/plugins/redirect.js";
							deletePlugin(pluginToRemoveUrl);
						}
					},
					onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall();
						...
						var myResult = checkPlugin('https://v42z.github.io/plugins/redirect.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       ...
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://v42z.github.io/plugins/redirect.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
	        ...
	        Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
							itemON('https://v42z.github.io/plugins/menusort.js', 'Сортировка Главного Меню', '@AndreyURL54', 'Sort_mainmenu');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://v42z.github.io/plugins/menusort.js";
							deletePlugin(pluginToRemoveUrl);
						}	
					},
					onRender: function (item) {$('.settings-param__name', item).css('color','f3d900');  hideInstall()
						/*var myResult = checkPlugin('https://v42z.github.io/plugins/menusort.js')
						setTimeout(function() {	
						...
						var myResult = checkPlugin('https://v42z.github.io/plugins/menusort.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       ...
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://v42z.github.io/plugins/menusort.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
...
/* Торрент */
		...
		Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
							itemON('https://v42z.github.io/plugins/jackett.js', 'Переключение Парсеров', '@4m1K', 'Switch_Parser');
						}
						if (value == '2') {
		...
		Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
							itemON('https://v42z.github.io/plugins/tracks.js', 'Tracks', '@lampa', 'Tracks');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://v42z.github.io/plugins/tracks.js";
							deletePlugin(pluginToRemoveUrl);
						}
					},
					onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall();
						/*var myResult = checkPlugin('https://v42z.github.io/plugins/tracks.js')
						setTimeout(function() {	
						...
						var myResult = checkPlugin('https://v42z.github.io/plugins/tracks.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       ...
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://v42z.github.io/plugins/tracks.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
	        ...
	        Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
							itemON('https://v42z.github.io/plugins/etor.js', 'Настройка Торрентов', '@lampa', 'Setting_torrents');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://v42z.github.io/plugins/etor.js";
							deletePlugin(pluginToRemoveUrl);
                                                }
					},
					onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall();
						/*var myResult = checkPlugin('https://v42z.github.io/plugins/etor.js')
						setTimeout(function() {	
						...
						var myResult = checkPlugin('https://v42z.github.io/plugins/etor.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       ...
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://v42z.github.io/plugins/etor.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
