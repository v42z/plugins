(function() {
  ...
  function startPlugin() {
    ...
    Lampa.Listener.follow('full', function(e) {
      if (e.type == 'complite') {
        setTimeout(function(){
                $(".view--online", Lampa.Activity.active().activity.render()).empty().append('<svg id="Layer_1" enable-background="new 0 0 74 74" viewBox="0 0 74 74" xmlns="http://www.w3.org/2000/svg"><g><path fill="currentColor" d="m69 8.99v56.01c0 2.21-1.79 4-4 4h-56c-2.21 0-4-1.79-4-4v-56.01c0-2.21 1.79-4 4-4h56c2.21 0 4 1.79 4 4z" fill="#f33" style="fill: rgb(0, 0, 0);"></path><path fill="currentColor" d="m11 10.99h52v52.01h-52z" fill="#fff"></path><path fill="currentColor" d="m63 10.99v1.59h-37.62c-7.06 0-12.79 5.73-12.79 12.79v37.63h-1.59v-52.01z" opacity=".05" fill="#000000"></path><g fill="#f33"><path fill="currentColor" d="m42.9 37.01 15.7 15.7h-9.45l-8.26-8.25v-14.92l8.26-8.25h9.45z" fill="#f33" style="fill: rgb(0, 0, 0);"></path><path fill="currentColor" d="m15.4 38.85 15.31-15.31v9.45l-5.86 5.86h5.86v6.69h-15.31z" fill="#f33" style="fill: rgb(0, 0, 0);"></path><path fill="currentColor" d="m32.45 21.29h6.69v31.41h-6.69z" fill="#f33" style="fill: rgb(0, 0, 0);"></path></g><path fill="currentColor" d="m66 8.99v56.01c0 .55-.45 1-1 1h-56c-.55 0-1-.45-1-1v-2h21.09c18.73.01 33.91-15.17 33.91-33.91v-21.1h2c.55 0 1 .46 1 1z" opacity=".05" fill="#000000"></path><g fill="#fff"><path fill="currentColor" d="m57.66 4.99v9.53c0 23.83-19.31 43.14-43.14 43.14h-9.52v-48.67c0-2.21 1.79-4 4-4z" opacity=".1" fill="#fff"></path><path fill="currentColor" d="m49.63 4.99v1.5c0 23.83-19.31 43.14-43.14 43.14h-1.49v-40.64c0-2.21 1.79-4 4-4z" opacity=".1" fill="#fff"></path></g></g></svg>&nbsp&nbsp4m1K');
        }, 5);
