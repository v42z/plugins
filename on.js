(function() {
  ...
  function startPlugin() {
    ...
    Lampa.Listener.follow('full', function(e) {
      if (e.type == 'complite') {
        setTimeout(function(){
                $(".view--online", Lampa.Activity.active().activity.render()).empty().append('<svg id="Layer_1" enable-background="new 0 0 74 74" viewBox="0 0 74 74" xmlns="http://www.w3.org/2000/svg"><g><path fill="currentColor" d="m65 4.5h-56c-2.48 0-4.5 2.01-4.5 4.5v56c0 2.48 2.02 4.5 4.5 4.5h56c2.48 0 4.5-2.02 4.5-4.5v-56c0-2.49-2.02-4.5-4.5-4.5zm3.5 60.5c0 1.93-1.57 3.5-3.5 3.5h-56c-1.93 0-3.5-1.57-3.5-3.5v-56c0-1.93 1.57-3.5 3.5-3.5h56c1.93 0 3.5 1.57 3.5 3.5z"></path><path fill="currentColor" d="m63 10.5h-52c-.28 0-.5.22-.5.5v52.01c0 .28.22.5.5.5h52c.28 0 .5-.22.5-.5v-52.01c0-.28-.22-.5-.5-.5zm-.5 52.01h-51v-51.01h51z"></path><path fill="currentColor" d="m16.9 44.9h15.05v7.8c0 .28.22.5.5.5h6.69c.28 0 .5-.22.5-.5v-7.04l7.41 7.4c.09.09.22.15.35.15h9.45c.2 0 .38-.12.46-.31s.03-.4-.11-.54l-15.34-15.36 15.34-15.35c.14-.14.19-.36.11-.54s-.26-.31-.46-.31h-9.45c-.13 0-.26.05-.35.15l-7.41 7.4v-7.04c0-.28-.22-.5-.5-.5h-6.69c-.28 0-.5.22-.5.5v.69c-.03.02-.07.03-.09.06l-15.31 15.3c-.09.09-.15.22-.15.35v6.69c0 .28.22.5.5.5zm15.05-7.69h-4.39l4.39-4.39zm15.66-15.42h8.04l-14.85 14.86c-.2.2-.2.51 0 .71l14.85 14.85h-8.04l-7.97-7.96v-14.5zm-14.66 0h5.69v30.41h-5.69zm-15.55 16.13 14.55-14.55v8.07c-.03.02-.07.03-.09.06l-5.86 5.86c-.14.14-.19.36-.11.54.08.19.26.31.46.31h5.6v5.69h-14.55z"></path></g></svg>&nbsp&nbsp4m1K');
        }, 5);
